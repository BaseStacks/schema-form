        ...
        <SchemaFormProvider
            ...
            components={{
                ...
                fields: {
                    ...
                    boolean: withController(BooleanField),
                    date: withController(DateField),
                    number: withController(NumberField),
                    select: withController(SelectField),
                    string: withController(StringField),
                }
            }}
            renderContext={{
                layout: {
...
function InnerForm({ form, children, onSubmit }: SchemaFormRenderProps<FormRenderContext>) {
    return (
